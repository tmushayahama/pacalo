...
export const GALLERY_IMAGES: GalleryImage[] = [
  {
    src: '/assets/images/vans/side_view_van.jpg',
  ...
  {
    src: '/assets/images/vans/van_side.jpg',
  ...
  {
    src: '/assets/images/vans/van_outside_house.png',
  ...
  {
    src: '/assets/images/vans/wheelchair_van.png',
  ...
  {
    src: '/assets/images/vans/inside_stretcher.png',
  ...
  {
    src: '/assets/images/vans/loaded_stretcher.jpg',
  ...
  {
    src: '/assets/images/vans/securement_system.jpg',
  ...
  {
    src: '/assets/images/vans/stretcher_can.jpg',
  ...
  {
    src: '/assets/images/stretcher.jpg',
